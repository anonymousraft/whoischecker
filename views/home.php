...
<div class="container-fluid div-center" style="padding-top:2.5rem;text-align:center !important;">
  <div class="row h-100">
    <div class="col-md-12 col-lg-12">
      <div class="card card-block w-25">
        <p class="new-feature">Try New <a href="dns.php">New DNS Records Checker</a></p>
      </div>
    </div>
  </div>
</div>
